...
from flaskblog import db, params
...
def new_post():
    ...
    return render_template(
        "create_post.html", title="New Post", params=params, form=form
    )
...
def update_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        form.tagline.data = post.tagline
        form.category.data = post.category
        form.content.data = post.content

    return render_template(
        "create_post.html", title="Update Post", params=params, form=form
    )
